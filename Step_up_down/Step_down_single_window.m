...
remove_ranges = { ...
    {[0, 1000], [2510, 3540] ,[5130,6402] ,[8128,9200] ,[9890,11000] }, ... % Ranges for file1
    {[0, 1000], [2510, 3540] ,[5130,6402] ,[8128,9200],[9890,11000]}, ... % Ranges for file2
    {[0, 1000], [2510, 3540] ,[5130,6402] ,[8128,9200],[9890,11000],} ...  % Ranges for file3
};
