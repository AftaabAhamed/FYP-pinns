...
class SphericalTankVisualizer:
    ...
    def draw(self, water_height_cm, time):
        ...
        # Display information
        rl.draw_text(f"Water Height: {water_height_cm / 25:.2f} cm", 10, 10, 20, rl.DARKGRAY)
...
def main():
    ...
    for water_height_cm in water_levels:
        if rl.window_should_close():
            break

        # Draw the current state
        curr_time += 1
        visualizer.draw(water_height_cm, str(curr_time))
